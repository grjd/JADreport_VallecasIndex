...
%YS Say number of feature, which are removed for low variance
\begin{figure}[!htb]
        \centering
...
\begin{figure}[!htb]
        ...
        \includegraphics[keepaspectratio, width=\linewidth]{figures/inpaper/importance_2019716171617}
...
%PDP one dimensional of soem of the most important features
\begin{figure}[]
    \centering
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[height=2.1in]{figures/inpaper/pdp_plot_nivel_educativo}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[height=2.1in]{figures/inpaper/pdp_plot_imc}
        \caption{PDP.}
    \end{subfigure}%\quad

    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[keepaspectratio,height=2.1in]{figures/inpaper/pdp_plot_edad_visita1}
        \caption{PDP.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.49\textwidth}
...
\begin{figure}[]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[keepaspectratio,height=3.8in]{figures/inpaper/pdp_plot_pair_1}
        \caption{PDP }
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[keepaspectratio,height=3.8in]{figures/inpaper/pdp_plot_pair_2}
        \caption{PDP.}
    \end{subfigure}%\quad

    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[keepaspectratio,height=3.8in]{figures/inpaper/pdp_plot_pair_3}
        \caption{PDP.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[keepaspectratio,height=3.8in]{figures/inpaper/pdp_plot_pair_4}
        \caption{PDP.}
    \end{subfigure}%\quad
