...
Mild cognitive impairment (MCI) is an intermediary stage between the expected decline of normal aging and the pathological decline associated to dementia. The incidence of Alzheimer’s disease grows exponentially with age, the identification of risk factors for MCI is thus, sorely needed. 
...
Self-reported features (easily accessible, low cost) ranked in importance relative to conversion to MCI has not only value as a predictor of conversion in asymptomatic stages, most importantly may help in the design of personalized interventions informed by the subject’s lifestyle.
In this study we leverage on \emph{The Vallecas Project}, a large longitudinal Spain based study on healthy aging, in order to build \emph{The Vallecas Index}. \emph{The Vallecas Index} 
using machine learning techniques -random forest- selects the most important self-reported variables for MCI conversion which includes subjective cognitive decline, educational level, working experience, social life and diet.
\end{abstract}
